...
public final class CLibrary
{
        ...
        try
        {
            ...
            if (errCode != 0)
            {
                ...
                while ((str = err.readLine()) != null)
                    buff.append(str).append(System.getProperty("line.separator"));
                throw new IOException("Exception while executing the command: "+  Joiner.on(" ").join(pb.command()) +
    ...
    {
        Field field = CLibrary.getProtectedField(descriptor.getClass(), "fd");
     ...
     */
    public static Field getProtectedField(Class<? extends FileDescriptor> klass, String fieldName)
    {
        Field field;
